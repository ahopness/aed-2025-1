/*
    Nome: biblioteca de ordenação
    Descrição: Implementação de diversos algoritmos de ordenação em C++, Para futuramente
    serem usados em um projeto da materia de Algoritmos e Estruturas de Dados. da Universidade
